...
function sankey() {
  ...
  function computeNodeLinks() {
    ...
    links.forEach(function (link$$1) {
      var source = link$$1.source,
          target = link$$1.target;
      if (typeof source === "number") source = link$$1.source = nodes[link$$1.source];
      if (typeof target === "number") target = link$$1.target = nodes[link$$1.target];
  ...
  function computeNodeBreadths() {
    ...
    while (remainingNodes.length) {
      ...
      remainingNodes.forEach(function (node) {
        node.x = x;
        node.dx = nodeWidth;
        node.sourceLinks.forEach(function (link$$1) {
          if (nextNodes.indexOf(link$$1.target) < 0) {
            nextNodes.push(link$$1.target);
          }
        });
      });
  ...
  function computeNodeDepths(iterations) {
    ...
    function relaxLeftToRight(alpha) {
      ...
      function weightedSource(link$$1) {
        return center(link$$1.source) * link$$1.value;
      }
    }
    ...
    function relaxRightToLeft(alpha) {
      ...
      function weightedTarget(link$$1) {
        return center(link$$1.target) * link$$1.value;
      }
    }
  ...
  function computeLinkDepths() {
    ...
    nodes.forEach(function (node) {
      ...
      node.targetLinks.forEach(function (link$$1) {
        link$$1.ty = ty;
        ty += link$$1.dy;
      });
    });
